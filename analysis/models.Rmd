...
The p-value of `r mcnemar_results$p.value` indicates that the marginal improvements `MASS::stepAIC()` made to the logistic model are not statistically significant.
