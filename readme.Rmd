...
* Deal with missing data problems
    ...
    * Impute missing data
      * mean imputation, look for values in past years of data (older pluto versions), regressions using other variables, mean by zipcode and builing type for example, see if missing-not-at-random
